        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 pt-10 items-start">
          ...
          >
            ...
            >
              ...
              <motion.p
                variants={itemVariants}
                className="mt-3 text-sm sm:text-base text-body leading-relaxed max-w-3xl line-clamp-3"
              >
                {featured.content}
              </motion.p>
              ...
              {/* Attachments */}
              {featured.lampiran &&
                featured.lampiran.length > 0 && (
                  <motion.div
                    variants={itemVariants}
                    className="mt-4 pt-3 border-t border-gray-200/60 flex items-center gap-2"
                  >
